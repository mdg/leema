...
const YYNSTATE: i32 = 188;
const YYNRULE: i32 = 100;
...
const YY_ACTION: [YYACTIONTYPE; 731] = [
 /*     0 */   168,  115,  171,   90,   67,  109,  159,  153,   46,  151,
 /*    10 */    92,  150,  106,  167,  119,   26,   35,  118,   90,   42,
 /*    20 */   188,    1,   14,  189,  151,    8,  150,  120,  167,   38,
 /*    30 */   183,  116,  112,  105,   12,  103,   89,  159,  108,  168,
 /*    40 */   115,  171,   98,    3,  154,  130,   66,   28,    4,  173,
 /*    50 */   172,  170,  169,    6,   26,   50,   11,   90,   71,   32,
 /*    60 */    25,   14,  166,  151,    8,  150,  144,  167,  162,  183,
 /*    70 */   116,  112,  105,   12,  103,  111,  157,  158,   29,   27,
 /*    80 */    24,   98,    3,   37,   30,   66,   28,  161,  173,  172,
 /*    90 */   170,  169,    6,    7,   50,   90,   70,  134,   32,   25,
 /*   100 */    34,  151,  107,  150,   35,  167,   22,   21,   23,  176,
 /*   110 */   152,   16,   15,   18,   17,   20,   19,   29,   27,   24,
 /*   120 */     7,  177,  104,  156,   48,   32,   25,   36,   49,  138,
 /*   130 */   137,  136,  135,   22,   21,   23,  176,  145,   16,   15,
 /*   140 */    18,   17,   20,   19,   29,   27,   24,    7,  147,   90,
 /*   150 */    70,  143,   32,   25,   13,  151,  146,  150,   25,  167,
 /*   160 */    22,   21,   23,  176,  102,   16,   15,   18,   17,   20,
 /*   170 */    19,   29,   27,   24,    5,   90,   68,   27,   24,   32,
 /*   180 */    25,  151,   63,  150,   91,  167,   62,   22,   21,   23,
 /*   190 */   176,  140,   16,   15,   18,   17,   20,   19,   29,   27,
 /*   200 */    24,   32,   25,  157,  158,   65,  159,   59,   97,   22,
 /*   210 */    21,   23,  176,  179,   16,   15,   18,   17,   20,   19,
 /*   220 */    29,   27,   24,  167,  147,   32,   25,   34,  155,   58,
 /*   230 */     1,   57,  132,   22,   21,   23,  176,   56,   16,   15,
 /*   240 */    18,   17,   20,   19,   29,   27,   24,   32,   25,  175,
 /*   250 */   156,  129,  126,  121,   31,   22,   21,   23,  176,  167,
 /*   260 */    16,   15,   18,   17,   20,   19,   29,   27,   24,  163,
 /*   270 */   113,    1,   90,   69,   64,  160,   32,   25,  151,  167,
 /*   280 */   150,   39,  167,  101,   22,   21,   23,  176,   39,   16,
 /*   290 */    15,   18,   17,   20,   19,   29,   27,   24,   53,  168,
 /*   300 */   115,  171,   60,   61,   45,   90,   86,  289,  117,    2,
 /*   310 */   100,  151,  182,  150,   26,  167,  181,   99,  180,  133,
 /*   320 */    94,   14,   96,   95,    8,  186,  185,  184,   90,   73,
 /*   330 */   131,   90,   44,   46,  151,  128,  150,  151,  167,  150,
 /*   340 */   125,  167,   10,  122,  124,   66,   28,    9,  173,  172,
 /*   350 */   170,  169,    6,  123,   50,   51,  168,  115,  171,   93,
 /*   360 */    90,   75,  114,  290,  165,  164,  151,  127,  150,  139,
 /*   370 */   167,   26,   52,   47,  110,   55,   90,   87,   14,   32,
 /*   380 */    25,    8,  151,   54,  150,  290,  167,  290,  290,   23,
 /*   390 */   176,  290,   16,   15,   18,   17,   20,   19,   29,   27,
 /*   400 */    24,  290,   66,   28,  290,  173,  172,  170,  169,    6,
 /*   410 */   290,   50,  168,  115,  171,  290,  290,  290,  290,  290,
 /*   420 */   290,  290,  187,    2,  290,  290,  182,   26,  290,  290,
 /*   430 */   181,  290,  180,  290,   14,  290,  290,    8,  178,  186,
 /*   440 */   185,  184,   90,   73,  290,   90,   43,  290,  151,  290,
 /*   450 */   150,  151,  167,  150,  290,  167,  290,  290,   66,   28,
 /*   460 */   290,  173,  172,  170,  169,    6,  290,   50,  168,  115,
 /*   470 */   171,  290,  290,  290,   90,  142,  290,  141,    2,  290,
 /*   480 */   151,  182,  150,   26,  167,  181,  290,  180,  290,  290,
 /*   490 */    14,  290,  290,    8,  186,  185,  184,   90,   73,  290,
 /*   500 */   290,  290,  290,  151,  290,  150,  290,  167,  290,  290,
 /*   510 */   290,  290,   10,  290,   66,   28,  290,  173,  172,  170,
 /*   520 */   169,    6,  290,   50,  168,  115,  171,   90,   79,  290,
 /*   530 */    90,  149,  290,  151,  290,  150,  151,  167,  150,   26,
 /*   540 */   167,  290,  290,  290,  290,  290,   14,   32,   25,    8,
 /*   550 */   290,  290,  290,  290,  290,  290,  290,  290,  176,  290,
 /*   560 */    16,   15,   18,   17,   20,   19,   29,   27,   24,  290,
 /*   570 */    66,   28,  290,  173,  172,  170,  169,    6,  290,   50,
 /*   580 */   290,   32,   25,  290,  168,  174,  171,  290,  290,  290,
 /*   590 */   290,  290,  290,  290,  288,  288,  288,  288,   20,   19,
 /*   600 */    29,   27,   24,  290,   90,  148,  290,   90,   78,   33,
 /*   610 */   151,  290,  150,  151,  167,  150,  290,  167,  290,   90,
 /*   620 */    77,  290,   90,   76,  290,  151,  290,  150,  151,  167,
 /*   630 */   150,  290,  167,  173,  172,  170,  169,  290,  290,   50,
 /*   640 */   290,  290,   90,   85,  290,   90,   84,  290,  151,  290,
 /*   650 */   150,  151,  167,  150,  290,  167,  290,  290,   90,   83,
 /*   660 */   290,   90,   82,  290,  151,  290,  150,  151,  167,  150,
 /*   670 */   290,  167,  290,  290,  290,  290,  290,  290,   90,   81,
 /*   680 */   290,   90,   80,  290,  151,  290,  150,  151,  167,  150,
 /*   690 */   290,  167,   90,   88,  290,  290,  290,  290,  151,  290,
 /*   700 */   150,  290,  167,   90,   74,  290,   90,   72,  290,  151,
 /*   710 */   290,  150,  151,  167,  150,  290,  167,   90,   41,  290,
 /*   720 */    90,   40,  290,  151,  290,  150,  151,  167,  150,  290,
 /*   730 */   167,
];
const YY_LOOKAHEAD: [YYCODETYPE; 731] = [
 ...
 /*    60 */     8,   26,   60,   89,   29,   91,   92,   93,   40,   34,
 /*    70 */    35,   36,   37,   38,   39,    5,    5,    6,   26,   27,
 /*    80 */    28,   46,   47,    5,   20,   50,   51,   40,   53,   54,
 /*    90 */    55,   56,   57,    2,   59,   83,   84,   10,    7,    8,
 /*   100 */    29,   89,   90,   91,    2,   93,   15,   16,   17,   18,
 /*   110 */    30,   20,   21,   22,   23,   24,   25,   26,   27,   28,
 /*   120 */     2,   30,    5,   52,    5,    7,    8,   49,    9,   42,
 /*   130 */    43,   44,   45,   15,   16,   17,   18,   58,   20,   21,
 /*   140 */    22,   23,   24,   25,   26,   27,   28,    2,   30,   83,
 /*   150 */    84,   30,    7,    8,   20,   89,   90,   91,    8,   93,
 /*   160 */    15,   16,   17,   18,    5,   20,   21,   22,   23,   24,
 /*   170 */    25,   26,   27,   28,    2,   83,   84,   27,   28,    7,
 /*   180 */     8,   89,   29,   91,   92,   93,   30,   15,   16,   17,
 /*   190 */    18,   40,   20,   21,   22,   23,   24,   25,   26,   27,
 /*   200 */    28,    7,    8,    5,    6,   77,   78,    2,    5,   15,
 /*   210 */    16,   17,   18,   83,   20,   21,   22,   23,   24,   25,
 /*   220 */    26,   27,   28,   93,   30,    7,    8,   29,   30,   29,
 /*   230 */    12,   30,   40,   15,   16,   17,   18,    2,   20,   21,
 /*   240 */    22,   23,   24,   25,   26,   27,   28,    7,    8,   83,
 /*   250 */    52,   40,   40,   30,   48,   15,   16,   17,   18,   93,
 /*   260 */    20,   21,   22,   23,   24,   25,   26,   27,   28,   83,
 /*   270 */    88,   12,   83,   84,   66,   76,    7,    8,   89,   93,
 /*   280 */    91,   48,   93,   68,   15,   16,   17,   18,   48,   20,
 /*   290 */    21,   22,   23,   24,   25,   26,   27,   28,    3,    4,
 /*   300 */     5,    6,    5,   86,   41,   83,   84,   62,   63,   64,
 /*   310 */    66,   89,   67,   91,   19,   93,   71,   86,   73,   68,
 /*   320 */     5,   26,   72,   66,   29,   80,   81,   82,   83,   84,
 /*   330 */    72,   83,   84,    3,   89,   74,   91,   89,   93,   91,
 /*   340 */    75,   93,   48,   88,   66,   50,   51,   48,   53,   54,
 /*   350 */    55,   56,   57,   66,   59,    3,    4,    5,    6,   74,
 /*   360 */    83,   84,   94,   95,   94,   94,   89,   66,   91,   85,
 /*   370 */    93,   19,   66,   66,   76,   66,   83,   84,   26,    7,
 /*   380 */     8,   29,   89,   66,   91,   95,   93,   95,   95,   17,
...
const YY_SHIFT_COUNT: i32 = 120;
const YY_SHIFT_MIN: i32 = -18;
const YY_SHIFT_MAX: i32 = 580;
const YY_SHIFT_OFST: [i16; 121] = [
 ...
 /*    30 */   520,  520,  520,  520,  198,   71,  580,  580,  580,   71,
 /*    40 */   218,  218,  218,  240,  218,   87,    9,    5,  119,  119,
 /*    50 */   119,  259,  299,  259,  294,  330,  315,  259,  315,  297,
 /*    60 */   263,  259,  263,  297,  233,  259,  206,  118,   91,  194,
 /*    70 */   172,  145,  269,  269,  269,  269,  372,  372,  540,  540,
 /*    80 */   574,  574,  574,  574,   52,   52,  150,  150,  150,   14,
 /*    90 */    78,  223,  212,  211,  235,  192,  201,  200,  203,  205,
 /*   100 */   151,  156,  153,  159,  134,  117,  121,   79,   80,  102,
 /*   110 */    47,   64,   70,   28,    2,   19,   25,   23,   20,  -16,
 /*   120 */   -18,
];
...
const YY_REDUCE_OFST: [i16; 67] = [
 ...
 /*    30 */   277,  248,  222,  189,  -41,  -72,  186,  166,  130,  128,
 /*    40 */   317,  309,  307,  298,  306,  284,  301,  285,  271,  270,
 /*    50 */   268,  287,  255,  278,  265,  261,  258,  257,  250,  251,
 /*    60 */   231,  244,  217,  215,  199,  208,  182,
];
const YY_DEFAULT: [YYACTIONTYPE; 188] = [
 /*     0 */   190,  190,  190,  288,  288,  278,  278,  288,  288,  288,
 ...
 /*    40 */   288,  288,  288,  288,  288,  288,  288,  288,  285,  285,
 /*    50 */   285,  288,  288,  288,  288,  224,  217,  288,  217,  206,
 /*    60 */   209,  288,  209,  206,  238,  288,  288,  288,  288,  288,
 /*    70 */   279,  282,  203,  202,  201,  200,  260,  259,  258,  250,
 /*    80 */   266,  265,  264,  263,  262,  261,  253,  254,  252,  288,
 /*    90 */   267,  288,  288,  288,  218,  288,  288,  288,  288,  207,
 /*   100 */   288,  288,  288,  288,  288,  288,  288,  288,  288,  246,
 /*   110 */   288,  288,  288,  288,  288,  269,  288,  288,  288,  288,
 /*   120 */   288,  230,  235,  234,  227,  226,  222,  225,  223,  221,
 /*   130 */   220,  219,  216,  208,  215,  214,  213,  212,  211,  210,
 /*   140 */   205,  204,  255,  281,  283,  277,  280,  268,  257,  256,
 /*   150 */   249,  248,  245,  247,  244,  243,  242,  241,  240,  239,
 /*   160 */   237,  236,  233,  232,  287,  286,  284,  276,  275,  274,
 /*   170 */   273,  272,  271,  270,  269,  231,  251,  229,  228,  199,
 /*   180 */   198,  197,  196,  195,  194,  193,  192,  191,
];
...
const YY_RULE_INFO: [YYCODETYPE; 100] = [
  62,
  62,
  63,
  63,
...
match (yyp1.minor,) {
 ...
 YYMinorType::YY14(yyres)
            ...
            ,
            46 /* cases ::= PIPE expr block PIPE ELSE block */
            => 
{
let yyres :  Val ;
let yyp5 = self.yystack.pop().unwrap();
...
match (yyp1.minor,yyp2.minor,yyp5.minor,) {
 ...
 YYMinorType::YY14(yyres)
            ...
            ,
            47 /* cases ::= PIPE expr block cases */
            => 
{
let yyres :  Val ;
let yyp3 = self.yystack.pop().unwrap();
...
match (yyp1.minor,yyp2.minor,yyp3.minor,) {
 ...
 YYMinorType::YY14(yyres)
            ...
            ,
            48 /* expr ::= MATCH expr match_case DOUBLEDASH */
            => 
{
let yyres :  Val ;
self.yystack.pop().unwrap();
...
match (yyp1.minor,yyp2.minor,) {
 ...
 YYMinorType::YY14(yyres)
            ...
            ,
            49 /* match_case ::= PIPE pexpr block match_case */
            => 
{
let yyres :  Val ;
let yyp3 = self.yystack.pop().unwrap();
...
match (yyp1.minor,yyp2.minor,yyp3.minor,) {
 ...
 YYMinorType::YY14(yyres)
            ...
            ,
            50 /* match_case ::= PIPE pexpr block */
            => 
{
let yyres :  Val ;
let yyp2 = self.yystack.pop().unwrap();
...
match (yyp1.minor,) {
 ...
 YYMinorType::YY14(yyres)
            ...
            ,
            57 /* ptuple ::= LPAREN pargs RPAREN */
          | 93 /* tuple ::= LPAREN tuple_args RPAREN */
            => 
{
let yyres :  Val ;
self.yystack.pop().unwrap();
...
match (yyp0.minor,yyp2.minor,) {
 ...
 YYMinorType::YY14(yyres)
            ...
            ,
            59 /* pargs ::= pexpr COMMA pargs */
          | 92 /* list_items ::= expr COMMA list_items */
            => 
{
let yyres :  Val ;
let yyp2 = self.yystack.pop().unwrap();
...
match (yyp0.minor,yyp2.minor,) {
 ...
 YYMinorType::YY14(yyres)
            ...
            ,
            80 /* term ::= LPAREN expr RPAREN */
          | 89 /* list ::= SquareL list_items SquareR */
            => 
{
let yyres :  Val ;
self.yystack.pop().unwrap();
...
match (yyp0.minor,yyp2.minor,) {
 ...
 YYMinorType::YY14(yyres)
            ...
            ,
            95 /* tuple_args ::= expr COMMA tuple_args */
            => 
{
let yyres :  Val ;
let yyp2 = self.yystack.pop().unwrap();
...
match (yyp0.minor,yyp2.minor,) {
 ...
 YYMinorType::YY14(yyres)
            ...
            ,
            96 /* strexpr ::= StrOpen strlist StrClose */
            => 
{
let yyres :  Val ;
self.yystack.pop().unwrap();
