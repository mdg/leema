...
use crate::leema::parser::{
    ...
    PrefixOpParser, PrefixParser, TokenParser,
};
...
const PARSE_TABLE: ParseTable = [
    (Token::Id, TokenParser::Prefix(&ParseId)),
    (Token::Int, TokenParser::Prefix(&ParseInt)),
    (Token::Bool, TokenParser::Prefix(&ParseBool)),
    (Token::Hashtag, TokenParser::Prefix(&ParseHashtag)),
    (Token::StrLit, TokenParser::Unimplemented),
    (Token::DollarId, TokenParser::Unimplemented),
    // brackets
    ...
    (Token::AngleR, TokenParser::Infix(OP_GT)),
    (Token::DoubleQuoteL, TokenParser::Prefix(&ParseStr)),
    (Token::DoubleQuoteR, TokenParser::Unimplemented),
    // statement keywords
    (Token::Const, TokenParser::Stmt(&ParseDefConst)),
    (Token::Else, TokenParser::Unimplemented),
    (Token::Failed, TokenParser::Unimplemented),
    (Token::Fork, TokenParser::Unimplemented),
    (
        Token::Func,
    ...
    (
        Token::Macro,
        TokenParser::Stmt(&ParseDefFunc(FuncClass::Macro)),
    ),
    (Token::Match, TokenParser::Prefix(&ParseMatch)),
    (Token::Return, TokenParser::Unimplemented),
    (Token::Type, TokenParser::Stmt(&ParseDefType)),
    (Token::Underscore, TokenParser::Unimplemented),
    // operators (arithmetic)
    (Token::Plus, TokenParser::Infix(OP_ADD)),
    (Token::Dash, TokenParser::Infix(OP_SUBTRACT)),
    (Token::Star, TokenParser::Infix(OP_MULTIPLY)),
    (Token::Slash, TokenParser::Infix(OP_DIVIDE)),
    (Token::Modulo, TokenParser::Infix(OP_MODULO)),
    (Token::Dollar, TokenParser::Unimplemented),
    // operators (boolean)
    (Token::And, TokenParser::Infix(OP_AND)),
    (Token::Not, TokenParser::Prefix(OP_NOT)),
    (Token::Or, TokenParser::Infix(OP_OR)),
    (Token::Xor, TokenParser::Infix(OP_XOR)),
    // operators (comparison)
    (Token::Equal, TokenParser::Infix(OP_EQ)),
    (Token::EqualNot, TokenParser::Infix(OP_NEQ)),
    (Token::GreaterThanEqual, TokenParser::Infix(OP_GTE)),
    (Token::LessThanEqual, TokenParser::Infix(OP_LTE)),
    // separators
    (Token::Assignment, TokenParser::ExprBreak),
    (Token::CasePipe, TokenParser::ExprBreak),
    ...
    (Token::Pipe, TokenParser::Unimplemented),
    (Token::Semicolon, TokenParser::Infix(OP_CONS)),
    (Token::StatementSep, TokenParser::Unimplemented),
    // comments
    (Token::CommentBlockStart, TokenParser::Unimplemented),
    (Token::CommentBlockStop, TokenParser::Unimplemented),
    (Token::CommentLine, TokenParser::Unimplemented),
    // whitespace
    (Token::EmptyLine, TokenParser::Unimplemented),
    (Token::LineBegin, TokenParser::ExprBreak),
    (Token::LineEnd, TokenParser::Unimplemented),
